...
interface BookingCalendarModalProps {
    ...
    bookingOnly?: boolean; // When true, hides history sidebar and focuses on new bookings
}
...
export const BookingCalendarModal = ({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent hideClose={true} className={cn(
                ...
                {/* Right Side: Sidebar (Detail Card) - Hidden in booking-only mode */}
                {!bookingOnly && (
